 ...
 *
 * Options:
 * - sliderDotId (string): The ID of the slider dot element.
 * - sliderDotParentId (string): The ID of the container for the slider dot.
 * - slideElementId (string): The ID of the slide element.
 * - initialPositionPercentage (number): Initial position as a percentage (0-100).
