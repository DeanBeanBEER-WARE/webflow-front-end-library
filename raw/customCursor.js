 ...
 *
 * Options:
 * - cursorClass (string): CSS class for the custom cursor element. Expected to be a class name (e.g., 'custom-cursor'). Default: 'custom-cursor'.
 * - hoverArray (Array<Object>): Array of objects defining hover triggers.
 *     Each object should have:
 *       - trigger (string): CSS class of the element that triggers a hover effect.
 *       - hoverstyle (string): CSS class to apply to the cursor during hover.
 * - downArray (Array<Object>): Array of objects defining mousedown triggers.
 *     Each object should have:
 *       - trigger (string): CSS class of the element for mousedown effect.
 *       - hoverstyle (string): CSS class to apply to the cursor during mousedown.
 * - dragTimer (number): Smoothing factor for cursor movement. Default: 50.
 * - downTime (number): Duration in milliseconds to hold the mousedown effect. Default: 300.
 *
 * Example:
 *
 * new CustomCursor({
